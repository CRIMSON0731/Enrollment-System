...
async function loadCurrentAnnouncements() {
    ...
    try {
        const response = await fetch('https://enrollment-system-production-b592.up.railway.app/get-announcements');
...
async function deleteAnnouncement(announcementId) {
    try {
        const response = await fetch('https://enrollment-system-production-b592.up.railway.app/delete-announcement', {
            method: 'POST',
...
async function handleAnnouncementSubmission(e) {
    ...
    try {
        const response = await fetch('https://enrollment-system-production-b592.up.railway.app/create-announcement', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
...
async function sendCredentialsOnly(applicationId) {
    ...
    try {
        const response = await fetch('https://enrollment-system-production-b592.up.railway.app/generate-credentials', { // Endpoint 15
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
...
async function deleteApplicant(applicationId) {
    try {
        const response = await fetch('https://enrollment-system-production-b592.up.railway.app/delete-application', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({ applicationId })
        });
...
async function simulateDataLoad() {
    ...
    try {
        const response = await fetch('https://enrollment-system-production-b592.up.railway.app/get-applications');
        const data = await response.json();
